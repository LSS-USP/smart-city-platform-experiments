...
CYCLES = ENV.has_key?('EXPERIMENT_CYCLES') ? ENV['EXPERIMENT_CYCLES'] : "10:20:30"
CYCLES_WAIT = ENV.has_key?('EXPERIMENT_WAIT') ? ENV['EXPERIMENT_WAIT'].to_i : 5
...
namespace :benchmark do
  ...
  task :load do
    ...
    clients_load = CYCLES.split(":")

    EXPERIMENTS.times do |i|
      clients_load.each do |clients|
        actors_load = clients.to_i
        ...
        puts "Wating #{CYCLES_WAIT} for the next experiment"
        sleep CYCLES_WAIT
      end
    end
    file.close
